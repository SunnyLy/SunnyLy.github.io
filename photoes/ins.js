    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://github.com/SunnyLy/sunnyPhotoes/tree/master/sunnyPhotoes/min_photoes/' + data.link[i] + '.min.jpg';
          var src = 'https://github.com/SunnyLy/sunnyPhotoes/tree/master/sunnyPhotoes/photoes/' + data.link[i];
          ...
          liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope="" itemtype="http://schema.org/ImageObject">\
                <a href="' + src + '" itemprop="contentUrl" data-size="640x640" data-type="' + type + '" data-target="' + target + '">\
                  <img class="reward-img" data-type="' + type + '" data-src="' + minSrc + '" src="/photoes/assets/img/empty.png" itemprop="thumbnail" onload="lzld(this)">\
                </a>\
